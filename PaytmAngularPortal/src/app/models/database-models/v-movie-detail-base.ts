...
//#region movieId Prop
        @gridColumn({visible: true, columnIndex:6, allowSorting: true, headerKey: 'movieId', keyColumn: false})
        movieId : number;
//#endregion movieId Prop


//#region availableSeats Prop
        @gridColumn({visible: true, columnIndex:7, allowSorting: true, headerKey: 'availableSeats', keyColumn: false})
        availableSeats : number;
//#endregion availableSeats Prop


//#region paytmUserId Prop
        @gridColumn({visible: true, columnIndex:8, allowSorting: true, headerKey: 'paytmUserId', keyColumn: false})
        paytmUserId : number;
...
//#region applicationObjectName Prop
        @gridColumn({visible: true, columnIndex:10, allowSorting: true, headerKey: 'applicationObjectName', keyColumn: false})
