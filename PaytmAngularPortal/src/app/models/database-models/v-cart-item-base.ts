...
//#region brandName Prop
        @gridColumn({visible: true, columnIndex:8, allowSorting: true, headerKey: 'brandName', keyColumn: false})
        brandName : string;
...
//#region productQuantity Prop
        @gridColumn({visible: true, columnIndex:10, allowSorting: true, headerKey: 'productQuantity', keyColumn: false})
...
//#region fashionSubCategoryName Prop
        @gridColumn({visible: true, columnIndex:3, allowSorting: true, headerKey: 'fashionSubCategoryName', keyColumn: false})
