...
namespace PaytmApp.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(PaytmApp.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(PaytmApp.Models.Main.LanguageContent.ComponentLanguageContents))]
